...
\begin{itemize}
  ...
  \item Inclure schéma d'architecture.
...
\subsection{Résultat 7 : co\^ut de calcul et difficultées rencontrées }
\begin{itemize}
...
\begin{itemize}
  ...
  \item Contribution algorithmique : scRAW, loss pondérée.
  \item Contribution expérimentale : recherche d'hyperparamètres et tests inductifs.
  \item Perspectives : à définir. ( valider les populations rares avec des marqueurs ou une expertise externe ? )
