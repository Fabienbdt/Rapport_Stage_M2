...
Le rapport peut suivre une progression en cinq parties : introduire le problème biologique et méthodologique, replacer les méthodes dans l'état de l'art, comment j'ai comparer l'existant, présenter scRAW et ses performances, puis ouvrir sur les expériences complémentaires.
...
\begin{itemize}
  ...
  \item l'état de l'art décrit les familles de méthodes, les données et les traitements qui conditionnent les résultats ;
  \item la comparaison de l'existant justifie la construction de SCRBenchmark d'où on comprend l'origine de scRAW ;
  \item scRAW est présenté comme une méthode centrée sur la pondération des cellules rares et l'apprentissage d'un espace latent adapté avec une suppression de l'effet batch;
