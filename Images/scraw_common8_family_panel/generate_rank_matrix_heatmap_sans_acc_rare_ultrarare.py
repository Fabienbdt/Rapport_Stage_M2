#!/usr/bin/env python3
"""Generate the common-8 rank matrix heatmap without ACC, RareACC, and UltraRareACC."""
...
OUTPUT_STEM = ROOT / "common8_rank_matrix_heatmap_sans_acc_rare_ultrarare"
...
def main() -> None:
    ...
    ranks.to_csv(ROOT / "common8_rank_matrix_heatmap_sans_acc_rare_ultrarare_ranks.csv")
    ...
    fig, ax = plt.subplots(figsize=(8.0, 5.7))  # Slightly narrower since fewer columns
    heatmap = sns.heatmap(
        ranks,
        ax=ax,
        cmap=cmap,
    ...
    plt.close(fig)
    print(f"Generated: {OUTPUT_STEM}.pdf")
