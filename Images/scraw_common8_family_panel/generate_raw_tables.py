...
CSV_PATH = Path("/Users/fabienbidet/Documents/MASTER2/STAGE/presentation_trial206_nonbaron_20260324/00_source_tables/trial206_all_results_table.csv")
...
PRIMARY_COLUMNS = {
    ...
    "Traditionnelles": ["scvi", "scMAE", "pca_leiden", "scNAME"],
...
HARMONY_COLUMNS = {
    ...
    "Trad. + Harmony": ["Harmony", "scvi", "scMAE+Harmony", "scNAME+Harmony"]
}
...
def main():
    ...
    for metric in METRICS:
        ...
        generate_table(
            ...
            caption=f"Résultats bruts de {metric_label} pour les méthodes principales sur les 8 jeux de données communs. La meilleure performance par jeu de données est en gras, et la deuxième est soulignée.",
        ...
        generate_table(
            ...
            caption=f"Résultats bruts complémentaires de {metric_label} avec Harmony pour les 8 jeux de données communs. La meilleure performance par jeu de données est en gras, et la deuxième est soulignée.",
