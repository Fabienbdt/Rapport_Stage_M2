...
# Path to the data
csv_path = "/data2/fbidet/Rapport_Stage_M2_git/Images/scraw_loss_transfer_synthesis/loss_transfer_by_dataset_algorithm_variant.csv"
...
metrics = ["ARI", "RareACC", "UltraRareACC"]
metric_titles = {
    "ARI": "ARI",
    "RareACC": "Rare ACC",
...
fig.text(
    0.5, 0.91, 
    "Moyennes par dataset ; meilleure variante sélectionnée par la moyenne ARI/RareACC/UltraRareACC.", 
...
# Save outputs
output_pdf = "/data2/fbidet/Rapport_Stage_M2_git/Images/scraw_loss_transfer_synthesis/loss_transfer_baseline_vs_best_weighted.pdf"
output_png = "/data2/fbidet/Rapport_Stage_M2_git/Images/scraw_loss_transfer_synthesis/loss_transfer_baseline_vs_best_weighted.png"
