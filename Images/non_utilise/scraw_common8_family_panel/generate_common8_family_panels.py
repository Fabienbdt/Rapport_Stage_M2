...
The script keeps only scRAW trial_0017, groups methods into the report
families requested for the M2 manuscript. The main figure shows scRAW
trial_0017 in every family/metric panel plus the top 3 methods for that metric
...
FAMILY_DISPLAY = {
    ...
    "Traditionnelles + Harmony": "Traditionnelles\n+ Harmony",
}

FAMILY_TABLE_DISPLAY = {
    "Rare Specific": "Rare Specific",
    "Methodes traditionnelles": "Méthodes traditionnelles",
    "Correction batch": "Correction batch",
    "Rare Specific + Harmony": "Rare Specific + Harmony",
    "Traditionnelles + Harmony": "Méthodes traditionnelles + Harmony",
}
...
FAMILY_COLORS = {
    ...
    "Traditionnelles + Harmony": "#B279A2",
}
