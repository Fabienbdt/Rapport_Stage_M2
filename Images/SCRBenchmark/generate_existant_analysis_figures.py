...
BARON_INDUCTIVE_SCIBE_ROOT = Path(
    "/data2/fbidet/SCRBenchmark/results/"
...
INDUCTIVE_ALGORITHMS = [
    ("pca_kmeans", "PCA+KMeans", BARON_INDUCTIVE_SCIBE_ROOT / "inductive_core"),
    ("pca_leiden", "PCA+Leiden", BARON_INDUCTIVE_SCIBE_ROOT / "inductive_core"),
    ("sc_mae", "scMAE", BARON_INDUCTIVE_SCIBE_ROOT / "inductive_core"),
    ("scdeepcluster", "scDeepCluster", BARON_INDUCTIVE_SCIBE_ROOT / "inductive_core"),
    ("scname", "scNAME", BARON_INDUCTIVE_SCIBE_ROOT / "inductive_scname"),
]
...
def plot_baron_inductive_transductive_error_panel() -> None:
    ...
    fig.text(
        ...
        "La metrique Batch corr. correspond a l'agregat scIB-e calcule sur les embeddings disponibles.",
        fontsize=8.3,
        color="#495057",
    )
