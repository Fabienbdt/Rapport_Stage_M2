...
- Output root: `/data2/fbidet/scRAW_EXPERIMENTAL/figures/01_stage_m2_report_trial206_nonbaron`
...
- Inductive bundle target: `/data2/fbidet/scRAW_EXPERIMENTAL/figures/01_stage_m2_report_trial206_nonbaron/04_inductive_tests/inductive_multidataset_top4_representative_20260428/04_figures`

## Included methods

- `scRAW (default)` (`scRAW (default)`)
- `scRAW (trial 0017)` (`scRAW (trial_0017)`)
- `scRAW (best per dataset)` (`scRAW (best per dataset)`)
- `scNAME` (`scNAME`)
- `scMAE` (`scMAE`)
- `Harmony` (`Harmony`)
- `ComBat` (`ComBat`)
