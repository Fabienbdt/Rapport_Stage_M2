...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{scraw_common8_family_panel/common8_family_top3_plus_scraw_panel.pdf}
    \caption{%
        ...
        de chaque famille~: \textbf{Rare Specific} (bleu),
        \textbf{Méthodes traditionnelles} (orange) et
        \textbf{Correction batch} (vert).
