...
Sur Baron, cette annotation par recouvrement atteint une exactitude de $94{,}8\,\%$ et une balanced accuracy de $88{,}9\,\%$, contre $93{,}4\,\%$ et $87{,}0\,\%$ pour le mapping hongrois. Les deux annotations concordent pour $97{,}4\,\%$ des cellules, ce qui indique que la clustering fait par \textbf{scRAW} est globalement en accord avec les marqueurs de référence, tout en fragmentant parfois certains types cellulaires en deux sous clusters, comme nous le voyons sur la figure~\ref{fig:baron_scraw_bio_interpretation}.
\begin{figure}[H]
    \centering
