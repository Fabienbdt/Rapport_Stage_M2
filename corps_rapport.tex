...
@{}}
\toprule
\textbf{Famille} & \textbf{Méthode} & \textbf{Framework} & \textbf{Nb. clusters} & \textbf{Objectif / loss} & \textbf{Réf.} & \textbf{Source} \\
\midrule
...
& DeepScena & Self-supervised hiérarchique & Hiérarchique & Raffinement coarse-to-fine des clusters rares & \cite{Lei2023scHDR} & Briefings in Bioinformatics \\
