...
{\color{gray}\itshape
\begin{itemize}
  \item Lister les méthodes comparées : PCA + Leiden, Harmony, ComBat, Scanorama, DESC, scMAE, scNAME, scVI, scRAW et tous les algorithmes pour lesquels il y a un résultat. 
