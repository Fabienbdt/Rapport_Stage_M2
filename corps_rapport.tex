...
\begin{figure}[htbp]
    ...
    \caption{%
        \textbf{Performances moyennes sur les huit jeux de données communs pour scRAW et le top 3 de chaque famille de méthodes.}
        ...
        Les barres représentent le score moyen sur les jeux de données communs (la valeur est indiquée au-dessus de chaque barre), et les barres d'erreur représentent l'écart type~;
