...
\begin{figure}[H]
    ...
    \end{subfigure}
    \vspace{-0.4em}
    \caption{Analyse biologique compacte de \textbf{scRAW} \texttt{trial0017/default} sur Baron Human Pancreas. Les panneaux combinent la structure latente, la concordance des marqueurs différentiels et la distribution des similarités de représentation afin d'évaluer la cohérence biologique du clustering sans dépasser une demi-page.}
