...
\begin{table}[H]
    ...
    \begin{tabular}{lrrl}
        ...
        \bottomrule
    \end{tabular}
    \caption{Composition du jeu de données Pancreas après filtrage. Les classes rares correspondent aux types représentant moins de 5\,\% des cellules, et les classes ultra-rares à ceux représentant moins de 1\,\%.}
...
\begin{figure}[H]
    ...
    \caption{Représentation simplifiée des principaux cadres expérimentaux utilisés sur le jeu de données Pancreas.}
