...
La perte principale de scRAW est une perte de reconstruction. Dans la configuration par défaut, il s'agit d'une erreur quadratique moyenne (MSE) calculée entre la matrice prétraitée \(X\) et sa reconstruction \(\hat{X}\). Pour une cellule \(i\), on peut l'écrire simplement :
\[
